...
const navigation = [
    ...
    { name: 'Policies',  href: '/dashboard', icon: PoliciesIcon },
    { name: 'Claims',    href: '/dashboard', icon: ClaimsIcon },
    { name: 'Clients',   href: '/dashboard', icon: ClientsIcon },
    { name: 'Reports',   href: '/dashboard', icon: ReportsIcon },
];
