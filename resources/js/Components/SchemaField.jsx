...
export default function SchemaField({ field, formId, depth = 0, mappings, availableFields, onChange, showHidden = false }) {
    ...
    // Form 4, 11, 12 & 16 specific: Hide Entry collapsible group
    if ((formId === '4' || formId === '11' || formId === '12' || formId === '16') && name === 'Entry') {
        return null;
    }
